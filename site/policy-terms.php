...
?>
  ...
  <p>If you choose to login to the vacation blog, you will be asked
    ...
    when you interact with the site. Your email address will be used to
    reset your password if you happen to lose that, and to receive
    occasional updates (although you can opt out of the latter).</p>

  <p>If you choose to login through facebook, your name and email
    will be stored (you can opt out of providing your facebook
    email). Your name will be displayed when you interact with the site.
    You can opt in to receiving email updates by going to the Preferences
  ...
  <p>You can choose to end your account by removing the
    ...
    <em>vacationblog@grivel.net</em> if you registered directly. Any
    comments you previously made will remain visible associated with
    your name. Please contact <em>vacationblog@grivel.net</em> if
    you have a concern with this.</p>

  <p>This website is provided as-is, without any warranty of anything.
