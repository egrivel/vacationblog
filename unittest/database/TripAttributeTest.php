...
class TripAttributeTest extends PHPUnit_Framework_TestCase {
   private $testTripId1;
   private $testTripId2;
   ...
   public function testNoSettersForKeyFields() {
      $this->assertTrue(method_exists('TripAttribute', 'getTripId'),
                        'getTripId() exists');
      $this->assertFalse(method_exists('TripAttribute', 'setTripId'),
                         'setTripId() does not exist');
      $this->assertTrue(method_exists('TripAttribute', 'getName'),
                        'getName() exists');
      $this->assertFalse(method_exists('TripAttribute', 'setName'),
   ...
   public function testCreateWithoutId() {
      ...
      $gotException = false;
      try {
         $object = new TripAttribute($testTripId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new TripAttribute($testTripId1, null);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new TripAttribute(null, 'name');
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
   ...
   public function testCreateGivesEmptyObject() {
      ...
      $this->assertEquals('', $object->getValue());
   ...
   public function testLoadExistent() {
      ...
      $object = new TripAttribute($testTripId2, 'name2');
      ...
      $this->assertTrue($object->load($testTripId1, 'name'));
      $this->assertEquals($testTripId1, $object->getTripId());
