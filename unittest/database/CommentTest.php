...
class CommentTest extends PHPUnit_Framework_TestCase {
   ...
   public function testCreateWithoutId() {
      ...
      $gotException = false;
      try {
         $object = new Comment($testTripId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Comment($testTripId1, null);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Comment(null, $testCommentId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
   ...
   public function testCreateGivesEmptyObject() {
      ...
      $this->assertEquals('', $object->getCommentText());
   ...
   public function testSetAttributes() {
      ...
      $object->setReferenceId('-test-reference-id');
      ...
      $this->assertEquals('-test-reference-id', $object->getReferenceId());
   ...
   public function testLoadInvalidKey() {
      ...
      $this->assertEquals('', $object->getCommentId());
      $this->assertNull($object->getCreated());
      $this->assertNull($object->getUpdated());
      $this->assertEquals('', $object->getUserId());
      $this->assertEquals('', $object->getReferenceId());
   ...
   public function testLoadNonExistent() {
      ...
      $object = new Comment($testTripId1, $testCommentId1);
      $object->setUserId($testUserId1);
      $object->setReferenceId('-test-reference-1');
      $object->setCommentText('comment text');
      $object->setDeleted('Y');
      $this->assertTrue($object->save());
      $this->assertEquals(1, $this->countTestRows());
   ...
   public function getHashGetNull() {
      ...
      $object = Comment::findByHash('non-existent hash');
   ...
   /**
    * Extra test. Find comment by reference id.
    * @depends testSetAttributes
    * @depends testLoadExistent
    * @depends testUpdate
    */
   public function testFindByReferenceId() {
      ...
      // find by reference without parameter returns null
      $list = Comment::findByReferenceId();
      $this->assertNull($list);

      // find by reference with empty string returns null
      $list = Comment::findByReferenceId('');
      $this->assertNull($list);

      // find by reference with empty string returns null
      $list = Comment::findByReferenceId($testTripId1);
      $this->assertNull($list);

      // find by reference with empty string returns null
      $list = Comment::findByReferenceId($testTripId1, null);
      $this->assertNull($list);
      ...
      // find by reference with an invalid ID returns null
      $list = Comment::findByReferenceId($testTripId1, $testCommentId1);
      $this->assertNull($list);
      ...
      $this->assertEquals($testCommentId2, $list[0]);
      $this->assertEquals($testCommentId3, $list[1]);

      $list = Comment::findByReferenceId($testTripId1, $testCommentId2);
      $this->assertNull($list);

      $list = Comment::findByReferenceId($testTripId1, $testCommentId3);
      $this->assertNotNull($list);
      $this->assertEquals(1, count($list));
      $this->assertEquals($testCommentId4, $list[0]);

      $list = Comment::findByReferenceId($testTripId1, $testCommentId4);
      $this->assertNull($list);
   }
}
?>
