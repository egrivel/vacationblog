...
class FeedbackTest extends PHPUnit_Framework_TestCase {
   ...
   public function testNoSettersForKeyFields() {
      ...
      $this->assertTrue(method_exists("Feedback", "getReferenceId"),
                        "getReferenceId exists");
      $this->assertFalse(method_exists("Feedback", "setReferenceId"),
                         "setReferenceId does not exist");
      $this->assertTrue(method_exists("Feedback", "getUserId"),
                        "getUserId exists");
      $this->assertFalse(method_exists("Feedback", "setUserId"),
   ...
   public function testCreateWithoutId() {
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1, null);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1, $testReferenceId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1, $testReferenceId1, null);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback(null, $testReferenceId1, $testUserId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback("", $testReferenceId1, $testUserId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1, null, $testUserId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Feedback($testTripId1, "", $testUserId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
   ...
   public function testLoadInvalidKey() {
      ...
      $this->assertFalse($object->load($testTripId1, $testReferenceId1));
      $this->assertEquals($testTripId1, $object->getTripId());
      $this->assertEquals($testReferenceId1, $object->getReferenceId());

      $this->assertFalse($object->load($testTripId1, $testReferenceId1, null));
      $this->assertEquals($testTripId1, $object->getTripId());
      $this->assertEquals($testReferenceId1, $object->getReferenceId());
      ...
      $this->assertFalse($object->load(null, $testReferenceId1, ''));
      $this->assertEquals($testReferenceId1, $object->getReferenceId());

      $this->assertFalse($object->load(null, null, $testUserId1));
      $this->assertEquals($testUserId1, $object->getUserId());

      $this->assertFalse($object->load('', '', $testUserId1));
      $this->assertEquals($testUserId1, $object->getUserId());
   }
   ...
   public function getHashGetNull() {
      ...
      $object = Feedback::findByHash('non-existent hash');
