...
class MediaTest extends PHPUnit_Framework_TestCase {
   ...
   */
   ...
   public function testNoSettersForKeyFields() {
      $this->assertTrue(method_exists("Media", "getTripId"),
                        "getTripId() exists");
      $this->assertFalse(method_exists("Media", "setTripId"),
                         "setTripId() does not exist");
      $this->assertTrue(method_exists("Media", "getMediaId"),
                        "getMediaId exists");
      $this->assertFalse(method_exists("Media", "setMediaId"),
                         "setMediaId does not exist");
   }
   ...
   public function testCreateWithoutId() {
      ...
      $gotException = false;
      try {
         $object = new Media($testTripId1, null);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
      ...
      $gotException = false;
      try {
         $object = new Media(null, $testMediaId1);
      } catch(InvalidArgumentException $expected) {
         $gotException = true;
      }
      $this->assertTrue($gotException);
   ...
   public function testCreateGivesEmptyObject() {
      ...
      $this->assertEquals('', $object->getCaption());
      $this->assertEquals('', $object->getTimestamp());
      $this->assertEquals('', $object->getLocation());
      $this->assertEquals('', $object->getWidth());
      $this->assertEquals('', $object->getHeight());
   ...
   public function testLoadInvalidKey() {
      ...
      $this->assertEquals('', $object->getMediaId());
      $this->assertNull($object->getCreated());
      $this->assertNull($object->getUpdated());
      $this->assertEquals('', $object->getType());
      $this->assertEquals('', $object->getCaption());
   ...
   public function testLoadNonExistent() {
      ...
      global $testTripId2, $testMediaId2;
      ...
      $this->assertEquals($testMediaId2, $object->getMediaId());
      $this->assertNull($object->getCreated());
      $this->assertNull($object->getUpdated());
      $this->assertEquals('', $object->getType());
      $this->assertEquals('', $object->getCaption());
   ...
   public function testLoadExistent() {
      ...
      $object = new Media($testTripId2, $testMediaId2);
   ...
   public function testOverrideAutomaticAttributesFutureDate() {
      ...
      $object->setCaption('2015-10-02');
      $object->setType('photo');
      $object->setTimestamp('Timestamp 3');
      $object->setLocation('location 3');
      $object->setWidth('1200');
      $object->setHeight('900');
      $object->setDeleted('Y');
      $this->assertTrue($object->save());
