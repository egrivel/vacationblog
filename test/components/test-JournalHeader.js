...
describe('components/JournalHeader', function() {
  ...
  const testDate1 = '2015-01-01';
  const testDate2 = '2015-01-02';
  const testUserName1 = 'test user 1';
  const testUserName2 = 'test user 2';
  const testCreated0 = '0000-00-00 00:00:00.000000';
  const testCreated1 = '2015-02-01 09:00:00.000000';
  const testCreated2 = '2015-02-02 09:00:00.000000';
  let props;
